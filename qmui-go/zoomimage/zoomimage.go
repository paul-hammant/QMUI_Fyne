// Package zoomimage provides a zoomable image with pan support
package zoomimage
...
// ZoomImage displays an image with zoom and pan support
...
// NewZoomImage creates a new zoom image view
func NewZoomImage() *ZoomImage {
	ziv := &ZoomImage{
		MinZoomScale:       0.5,
		MaxZoomScale:       3.0,
...
// NewZoomImageWithResource creates a zoom image view with an image
func NewZoomImageWithResource(img fyne.Resource) *ZoomImage {
	ziv := NewZoomImage()
	ziv.Image = img
	return ziv
}
...
func (ziv *ZoomImage) SetImage(img fyne.Resource) {
	ziv.mu.Lock()
	ziv.Image = img
...
func (ziv *ZoomImage) SetZoomScale(scale float32) {
	ziv.mu.Lock()
...
func (ziv *ZoomImage) Pan(deltaX, deltaY float32) {
	if !ziv.PanEnabled {
		return
	}
...
func (ziv *ZoomImage) constrainOffset() {
	viewSize := ziv.Size()
...
func (ziv *ZoomImage) DoubleTapped(e *fyne.PointEvent) {
...
func (ziv *ZoomImage) Scrolled(e *fyne.ScrollEvent) {
	ziv.mu.RLock()
...
func (ziv *ZoomImage) MouseDown(e *desktop.MouseEvent) {
	ziv.mu.Lock()
	ziv.isDragging = true
...
func (ziv *ZoomImage) MouseUp(e *desktop.MouseEvent) {
	ziv.mu.Lock()
...
func (ziv *ZoomImage) Dragged(e *fyne.DragEvent) {
	if !ziv.PanEnabled {
		return
	}
...
func (ziv *ZoomImage) CreateRenderer() fyne.WidgetRenderer {
	ziv.ExtendBaseWidget(ziv)
...
// ZoomImageWrapper wraps a ZoomImage with additional controls
type ZoomImageWrapper struct {
	widget.BaseWidget
...
// NewZoomImageWrapper creates a wrapped zoom image view
func NewZoomImageWrapper(img fyne.Resource) *ZoomImageWrapper {
	wrapper := &ZoomImageWrapper{
		ZoomView:                NewZoomImageWithResource(img),
		ShowsControls:           true,
...
// CreateRenderer implements fyne.Widget
func (w *ZoomImageWrapper) CreateRenderer() fyne.WidgetRenderer {
...
func NewGestureZoomHandler(view *ZoomImage) *GestureZoomHandler {
