// Package navigation provides QMUINavigationTitleView and navigation components
...
// NavigationTitleView is a customizable navigation title view
type NavigationTitleView struct {
	widget.BaseWidget
...
// NewNavigationTitleView creates a new navigation title view
func NewNavigationTitleView() *NavigationTitleView {
	config := core.SharedConfiguration()
	ntv := &NavigationTitleView{
...
// NewNavigationTitleViewWithTitle creates a title view with title
func NewNavigationTitleViewWithTitle(title string) *NavigationTitleView {
	ntv := NewNavigationTitleView()
	ntv.Title = title
	return ntv
}

// NewNavigationTitleViewWithTitleAndSubtitle creates a title view with title and subtitle
func NewNavigationTitleViewWithTitleAndSubtitle(title, subtitle string) *NavigationTitleView {
	ntv := NewNavigationTitleView()
	ntv.Title = title
...
func (ntv *NavigationTitleView) SetTitle(title string) {
	ntv.mu.Lock()
	ntv.Title = title
	ntv.mu.Unlock()
	ntv.Refresh()
...
func (ntv *NavigationTitleView) SetSubtitle(subtitle string) {
	ntv.mu.Lock()
	ntv.Subtitle = subtitle
	ntv.mu.Unlock()
	ntv.Refresh()
...
func (ntv *NavigationTitleView) SetLoading(loading bool) {
	ntv.mu.Lock()
	ntv.loading = loading
	ntv.mu.Unlock()
	ntv.Refresh()
...
func (ntv *NavigationTitleView) CreateRenderer() fyne.WidgetRenderer {
	ntv.ExtendBaseWidget(ntv)
...
func (ntv *NavigationTitleView) Tapped(_ *fyne.PointEvent) {
...
func (ntv *NavigationTitleView) TappedSecondary(_ *fyne.PointEvent) {}

func (ntv *NavigationTitleView) Cursor() desktop.Cursor {
