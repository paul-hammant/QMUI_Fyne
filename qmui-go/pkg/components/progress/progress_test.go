...
func TestPieProgressView_VisualUpdate(t *testing.T) {
	pie := NewPieProgressView()
...
func TestCircularProgressView_VisualUpdate(t *testing.T) {
	circular := NewCircularProgressView()
...
func TestLinearProgressView_VisualWidth(t *testing.T) {
	linear := NewLinearProgressView()
...
func TestProgressViews_MinSize(t *testing.T) {
	tests := []struct {
		...
		{"PieProgress", NewPieProgressView()},
		{"CircularProgress", NewCircularProgressView()},
		{"LinearProgress", NewLinearProgressView()},
	}
