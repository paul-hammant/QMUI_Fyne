...
func TestMarqueeLabel_Creation(t *testing.T) {
	ml := marquee.NewMarqueeLabel("Scrolling text that is long enough to scroll")
...
func TestMarqueeLabel_AnimationStart(t *testing.T) {
	ml := marquee.NewMarqueeLabel("This text should scroll continuously when started")
	ml.Speed = 50
...
func TestMarqueeLabel_AnimationStop(t *testing.T) {
	ml := marquee.NewMarqueeLabel("Scrolling text")
	ml.Speed = 50
...
func TestMarqueeLabel_DirectionLeftToRight(t *testing.T) {
	ml := marquee.NewMarqueeLabel("Scrolling right to left")
...
func TestMarqueeLabel_SpeedSetting(t *testing.T) {
	ml := marquee.NewMarqueeLabel("Speed test")
...
func TestPopupMenu_Creation(t *testing.T) {
	...
	menu := popup.NewPopupMenuViewWithItems(items)
...
func TestPopupContainerView_Arrow(t *testing.T) {
	pc := popup.NewPopupContainerView()
...
func TestEmotionView_GroupSelection(t *testing.T) {
	...
	ev := emotion.NewEmotionViewWithGroups([]*emotion.EmotionGroup{group1, group2})
...
func TestGridView_AddItems(t *testing.T) {
	...
	for i := 0; i < 8; i++ {
		item := grid.NewGridViewItem(label.NewLabel("Item"))
		gv.AddItem(item)
	}
...
func TestTableView_Sections(t *testing.T) {
	tv := table.NewTableView(table.TableViewStyleGrouped)

	section1 := table.NewTableSection("Section 1")
	section1.Cells = []*table.TableViewCell{
		table.NewTableViewCellWithText("Cell 1"),
		table.NewTableViewCellWithText("Cell 2"),
	}

	section2 := table.NewTableSection("Section 2")
	section2.Cells = []*table.TableViewCell{
		table.NewTableViewCellWithTextAndDetail("Cell 3", "Detail"),
	}
...
func TestNavigationBar_Title(t *testing.T) {
	nb := navigation.NewNavigationBar()
	titleView := navigation.NewNavigationTitleViewWithTitle("My Title")
...
func TestNavigationTitleView_Loading(t *testing.T) {
	tv := navigation.NewNavigationTitleViewWithTitle("Loading...")
...
func TestAlertController_Alert(t *testing.T) {
	ac := alert.NewAlertController("Alert", "This is a message", alert.ControllerStyleAlert)
...
func TestAlertController_ActionSheet(t *testing.T) {
	ac := alert.NewAlertController("Choose", "", alert.ControllerStyleActionSheet)
...
func TestDialogViewController_Creation(t *testing.T) {
	...
	dvc := dialog.NewDialogViewControllerWithContent(content)
...
func TestDialogViewController_Actions(t *testing.T) {
	...
	dvc.AddAction(dialog.NewDialogAction("OK", dialog.DialogActionStyleDefault))
	dvc.AddAction(dialog.NewDialogAction("Cancel", dialog.DialogActionStyleCancel))
...
func TestModalPresentation_AnimationStyles(t *testing.T) {
	...
	for _, style := range styles {
		mvc := modal.NewModalPresentationViewControllerWithContent(content)
...
func TestMoreOperationController_Creation(t *testing.T) {
	moc := moreop.NewMoreOperationController()

	items := []*moreop.MoreOperationItem{
		moreop.NewMoreOperationItem("share", "Share", nil, func(*moreop.MoreOperationItem) {}),
		moreop.NewMoreOperationItem("copy", "Copy", nil, func(*moreop.MoreOperationItem) {}),
	}
	moc.AddItems(items...)
...
func TestEmptyView_Loading(t *testing.T) {
	ev := empty.LoadingEmptyView("Loading data...")
...
func TestEmptyView_Error(t *testing.T) {
	ev := empty.ErrorEmptyView("Failed to load", func() {})
